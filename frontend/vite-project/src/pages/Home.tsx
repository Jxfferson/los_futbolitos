      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { name: "Hombre", image: "https://images.unsplash.com/photo-1549298916-b41d501d3772?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
              { name: "Mujer", image: "https://images.unsplash.com/photo-1552346154-21d32810aba3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
              { name: "Niño/a", image: "https://images.unsplash.com/photo-1586771779443-9e37995b1227?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
              { name: "Deporte", image: "https://images.unsplash.com/photo-1542298060-656472735986?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" }
            ].map((cat, i) => (
              <div
                key={i}
